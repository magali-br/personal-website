...
function Bt(t2) {
  try {
    if (decodeURIComponent(t2).replace(/[^A-Za-z0-9/:]/g, "").match(/^\s*(javascript|vbscript|data(?!:image)):/i)) return;
  } catch (t3) {
    return null;
  }
  return t2;
...
`, { _: e3 }));
    ...
    if (r2.length > 1 || u2.forceWrapper) c2 = r2;
      ...
      if (1 === r2.length) return c2 = r2[0], "string" == typeof c2 ? H2("span", { key: "outer" }, c2) : c2;
      c2 = null;
    }
...
var index_modern_default = (n2) => {
  let { children: r2, options: o2 } = n2, c2 = function(t2, n3) {
    ...
    for (r3 = 0; r3 < c3.length; r3++) n3.indexOf(e2 = c3[r3]) >= 0 || (o3[e2] = t2[e2]);
    return o3;
  }(n2, e);
